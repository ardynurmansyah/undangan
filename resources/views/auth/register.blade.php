            ...
            <div class="col-md-6">
                <form  action="" method="post">
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="" placeholder="Masukan nama anda">
                    </div>
                    <div>
                        <label>Alamat Email</label>
                    </div>
                    <div class="form-group">
                        <input class="form-control" type="email" name="" placeholder="Masukan alamat email">
                    </div>
                    <div>
                        <label>Kata Sandi</label>
                    </div>
              <div class="form-group">
                <input class="form-control" type="password" name="" placeholder="Masukan password">
              </div>
              <div>
                <label>Konfirmasi Kata Sandi</label>
              </div>
              <div class="form-group">
                <input class="form-control" type="password" name="" placeholder="Ulangi password">
              </div>
                    <div class="form-group">
