...
<body>
    ...
    <main role="main">
      ...
      <div class="jumbotron" style="background: url('{{ asset('img/alhamdulillah.jpg')}}'); background-size: cover; font-family: Arial; padding-top: 150px; padding-bottom: 100px;">
    ...
    <a class="wac-stickytext wac-leftm" target="_blank" href=""><img class="wac-wa" src="{{ asset('img/wa.png')}}">
    </a>
